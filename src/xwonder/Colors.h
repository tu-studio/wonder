 ...
 *
 *      \details
 *      These are some definitions for colors which are used by the sourcewidgets and the
 * sources3Dwidget for initialization of new colors.
 *
 *      \author
 *      Hans-Joachim Mond
 *
...
static GLfloat colors[][4] = {{0.0, 1.0, 0.0, 1.0},                 // green
