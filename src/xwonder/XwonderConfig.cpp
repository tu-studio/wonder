        ...
        switch(c) {
            ...
            case 'h':
                std::cout
                     ...
                     << "-t x (x = timeout in ms for connection to cwonder, by default it is turned off and uses 0ms)" << std::endl
                     << "-n x (x = name under which to connect to cwonder)"                                            << std::endl
                     << "-d   (demomode, run without connecting to cwonder)"                                           << std::endl
                     << "-v   (verbose mode, prints received OSC messages to console)"                                 << std::endl
                     << std::endl;
