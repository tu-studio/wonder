...
_WONDER_ is a software suite for using Wave Field Synthesis originally developed
by the Audiocommunication Group at TU Berlin.

The _WONDER_ suite is composed of the following components:
...
the [project documentation](https://tu-studio.github.io/wonder/).
